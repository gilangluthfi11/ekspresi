            ...
            <div class="box-body no-padding">
              <table class="table table-bordered table-hover">
                <tr>
                  ...
                  <th style="width: 15%;">Judul Artikel</th>
                  <th style="width: 25%;">Isi Artikel</th>
                  <th style="width: 5%;">Penulis</th>
                  <th style="width: 10%;">Tanggal</th>
                  <th style="width: 15%;">Action</th>
                </tr>
                <tr>
                  <td><strong>001</strong></td>
                  <td>Manfaat kerja di Coworking Space</td>
                  <td>lorem ipsum</td>
                  <td>Admin</td>
                ...
                <tr>
                  <td><strong>001</strong></td>
                  <td>5 Hal Positif yang Kamu dapat ..</td>
                  <td>lorem ipsum</td>
                  <td>Admin</td>
