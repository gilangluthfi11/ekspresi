...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo asset_url();?>backend/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    ...
    <a href="<?php echo base_url();?>admin_login"><b>Ekspresi</b>. Admin Panel</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="dashboard.html" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="button" class="btn bg-info btn-flat"><a href="<?php echo base_url();?>admin_panel">Masuk</a></button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- iCheck -->
<script src="<?php echo asset_url();?>backend/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
