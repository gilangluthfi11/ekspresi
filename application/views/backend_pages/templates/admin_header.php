...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url();?>admin/admin_panel" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini">E.P.S</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Ekspresi Admin Panel</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo asset_url();?>backend/img/user2-160x160.jpg" class="user-image" alt="User Image">
